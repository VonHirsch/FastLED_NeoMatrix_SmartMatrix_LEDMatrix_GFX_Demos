...
- Everything below is NeoMatrix in different patterns:
  M16BY16 M32BY8X3 M16BY16T4 M64BY64 are 4 examples of NEOMATRIX defines
...
// Then just uncomment this line below (define M16BY16) and fix the matrix definition
...
#if !defined(M16BY16) && !defined(M32BY8X3) && !defined(M16BY16T4) && !defined(M64BY64) && !defined(SMARTMATRIX) && !defined(SSD1331) && !defined(ST7735_128b128) && !defined(ST7735_128b160) && !defined(ILI9341) && !defined(ARDUINOONPC)
    #ifdef ESP8266
    //#define SSD1331
...
//============================================================================
#else
    #error "Please write a matrix config or choose one of the definitions above. If you have a FastLED matrix, define M16BY16 at the top of this file"
#endif
